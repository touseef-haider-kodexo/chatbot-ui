...
DECLARE
  ...
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.ewogICJyb2xlIjogInNlcnZpY2Vfcm9sZSIsCiAgImlzcyI6ICJzdXBhYmFzZSIsCiAgImlhdCI6IDE3MjcxMTgwMDAsCiAgImV4cCI6IDE4ODQ4ODQ0MDAKfQ.cmSBAVplJeo9gvzBuc6tLLMyLsQ_wsJB3_amTRsFQGY'; -- full access needed for http request to storage
